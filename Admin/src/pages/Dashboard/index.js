          ...
          <div className="right-content w-100">
           <div className="row dashboardBoxWrapperRow">
            ...
            <div className="dashboardBoxWrapper d-flex">
               ...
               <DashboardBox title="Total Users" count="277" color={["#1da256","#48d483"]} icon={<FaUserCircle/>}
               grow={true}/>
               <DashboardBox title="New Orders" count="112" color={["#c012e2","#eb64fe"]} icon={<FaShoppingCart/>}/> 
               <DashboardBox title="Feedbacks" count="350" color={["#2c78e5","#60aff5"]} icon={<FaShoppingBag/>}/> 
